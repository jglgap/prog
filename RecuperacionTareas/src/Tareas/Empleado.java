...
public void validaorDNI(String DNI){
	...
	public void limitador(String trabajador, String empresa){
		...
		this.empresa.limitador(empresa);
		delimit.close();
		}
	public void recogerEmpleado() {
		String recoger =this.toString();
	}
	// toString
	public String toString(){
		return "DNI: "+ this.getDNI()+ " Nombre: "+ this.getNombre()+ " Apes: "+ this.getApes()+" Lugar de nacimiento: "+ this.getLugNac()+" Edad: "+ this.getEdad()+"Empresa: "+this.empresa;
	}
